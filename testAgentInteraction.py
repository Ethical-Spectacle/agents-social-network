...
home_agent = Agent(network_id=network_id, agent_id="1", db=db)
away_agent = Agent(network_id=network_id, agent_id="2", db=db)
...
def run_test_interaction():
    ...
    # interaction method
    home_agent.handle_agent_interaction(partner_agent_id="2")
