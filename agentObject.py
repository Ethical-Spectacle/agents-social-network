...
######################### AGENTS CHAT ########################
    ...
    def handle_agent_interaction(self, partner_agent_id):
        ...
        home_agent = assert_transform_module(AgentChatModule(self.db, self.agent_id, self.chat_history), backtrack_handler) # active suggestions (used in relevance check)
        away_agent = assert_transform_module(AgentChatModule(self.db, self.agent_id, self.chat_history), backtrack_handler) # active suggestions (used in relevance check)
